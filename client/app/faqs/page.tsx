...
export default function Page() {
  const faqs = [
    ...
    {
      id: "faq-7",
      question: "I want to be a worker, how can I join a department or serve in church?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Yes, we provide prayer and pastoral counseling by appointment.",
    },
    {
      id: "faq-9",
    ...
    {
      id: "faq-11",
      question: "Do you organize outreach or community programs?",
      answer:
